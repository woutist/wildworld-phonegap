...
var startGame=function(type,lastMap) {
    ...
    setTimeout(function(){
        ...
        // toolsGame.mainElements.blankTileS.obj = game.add.group();
        // toolsGame.mainElements.blankTileS.obj.enableBody = true;
	    ...
	    for(var x=0; x<map.width; x++)
	    {
	    	for(var y=0; y<map.height; y++)
	    	{
                ...
                //generowanie blank tile
                // if (map.getTile(x, y, layer, true).index==51)
                // {
                //     toolsGame.mainElements.blankTileS.add(x,y);
                //     map.removeTile(x, y, layer);
                // }

				//generowanie building1
                if (map.getTile(x, y, layer, true).index==2)
                {
                ...
                if (map.getTile(x, y, layer, true).index==4)
                {
                ...
                if (map.getTile(x, y, layer, true).index==5)
                {
                ...
                //generowanie mine
                if (map.getTile(x, y, layer, true).index==6)
                {
                ...
                if (map.getTile(x, y, layer, true).index==511)
                {
                ...
                if (map.getTile(x, y, layer, true).index==512)
                {
                ...
                //generowanie klucza
                if (map.getTile(x, y, layer, true).index==515)
                {
                ...
                //generowanie drzwi
                if (map.getTile(x, y, layer, true).index==516)
                {
                    toolsGame.mainElements.doors.add(x,y);
                    map.removeTile(x, y, layer);
                }
                //generowanie zamków/locks
                if (map.getTile(x, y, layer, true).index==517) //lewy
                {
                    toolsGame.mainElements.locks.add(x,y);
                    map.removeTile(x, y, layer);
                }
                if (map.getTile(x, y, layer, true).index==467) //prawy
                {
                ...
                if (map.getTile(x, y, layer, true).index==602)
                {
                ...
                if (map.getTile(x, y, layer, true).index==111)
                {
                ...
                if (map.getTile(x, y, layer, true).index==110)
                {
                ...
                if (map.getTile(x, y, layer, true).index==109)
                {
                ...
                if (map.getTile(x, y, layer, true).index==112)
                {
                    toolsGame.mainElements.fire.fireRightS.add(x,y);
                    map.removeTile(x, y, layer);
                }

                //generowanie windmill
                // if (map.getTile(x, y, layer, true).index==3)
                // {
                //     toolsGame.mainElements.windmills.add(x,y);
                //     map.removeTile(x, y, layer);
                // }
	    ...
	    for(var x=0; x<map.width; x++)
	    {
	    	for(var y=0; y<map.height; y++)
	    	{
                ...
                if (map.getTile(x, y, layer, true).index==510)
                {
                ...
                if (map.getTile(x, y, layer, true).index==460)
                {
                ...
                if (map.getTile(x, y, layer, true).index==509)
                {
                ...
                if (map.getTile(x, y, layer, true).index==507)
                {
                ...
                if (map.getTile(x, y, layer, true).index==508)
                {
                ...
                // //generowanie wody
                // if (map.getTile(x, y, layer, true).index==518)
                // {
        ...
        // toolsGame.mainElements.splashs.add(x,y);

        for(var x=0; x<map.width; x++) {
            for (var y = 0; y < map.height; y++) {
                // generowanie ryb
                if (map.getTile(x, y, layer, true).index==520)
                {
                ...
                if (map.getTile(x, y, layer, true).index==521)
                {
                ...
                if (map.getTile(x, y, layer, true).index==519)
                {
        ...
        //console.log(toolsGame.mainElements.coins.obj.children.length);
        //console.log("bonus coins:");
        //console.log(toolsGame.mainElements.logs.lengthBonusCoins);
